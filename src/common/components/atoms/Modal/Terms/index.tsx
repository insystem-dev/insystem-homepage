...
export const Terms = ({ termType }: TermProps) => {
  return (
    <>
      {termType === "homepageUse" && (
        <>
          제1조(목적)
          <br />
          이 약관은 ㈜인시스템(전자상거래 사업자)이 운영하는 인시스템
          홈페이지(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하
          ...
          제2조(정의)
          <br />
          ① “몰”이란 (주)인시스템이 재화 또는 용역(이하 “재화 등”이라 함)을
          ...
          이상의 사전 유예기간을 두고 공지합니다. 이 경우 "몰“은 개정 전 내용과
          ...
          전의 약관조항이 그대로 적용됩니다.
          <br />
          다만 이미 계약을 체결한 이용자가 개정약관 조항의 적용을 받기를 원하는
          뜻을 제3항에 의한 개정약관의 공지기간 내에 “몰”에 송신하여 “몰”의
          ...
          개인정보의 수집·이용·제공에 관한 이용자의 동의 거절을 이유로 회원가입
      ...
      {termType === "private" && (
        <>
          1. 개인정보의 수집· 이용 목적
          <br />
          (주)인시스템이 운영하는 (주)인시스템 홈페이지는 다음의 목적을 위하여
          ...
          2) 고객 상담 및 AS관리
          <br />
          3) 서비스 변경사항 및 고지사항 전달
          <br />
          4) SNS를 통한 혜택 안내
          <br />
          5) 기획전/이벤트/기타 마케팅 활용 목적
          <br />
          <br />
          2. 수집· 이용하는 개인정보의 항목
          <br />
          개인식별정보 (성명, 연락처, 주소), 이메일, 개인식별코드(아이디),
          비밀번호
          <br />
          <br />
          3. 개인정보의 보유 및 이용기간
          <br />
          1) 수집된 개인정보는 이용목적이 달성된 후 지체 없이 파기됩니다.
          <br />
          2) 구체적인 개인정보 처리 및 보유 기간은 다음과 같습니다.
          <br />
          ① 서비스 이용 필수 수집 항목회원가입 철회 시 파기
          <br />
          단, 채권/채무 관계 잔존 시 해당 채권/채무관계 정산 시 까지서비스
          이용에 필요한 최소한의 개인정보 수집 및 이용에 동의하지 않을 수
          있으나, 이에 대한 동의가 없을 경우, 서비스 이용이 불가능할 수 있음을
          알려 드립니다.
          <br />
          ② 부가서비스 이용 필수 수집 항목회원가입 철회 시 파기
          <br />
          단, 채권/채무 관계 잔존 시 해당 채권/채무관계 정산 시 까지 개인정보
          수집 및 이용에 동의하지 않을 권리가 있으며, 동의를 거부할 경우 거부한
          내용과 관련된 서비스를 제공 받을 수 없습니다.
          <br />
          <br />
          4. 이용자 및 법정대리인의 권리와 그 행사방법
          <br />
          ① 정보주체는 (주)인시스템에 대해 언제든지 다음 각 호의 개인정보 보호
          관련 권리를 행사할 수 있습니다.
          <br />
          1) 개인정보 열람요구
          <br />
          ...
          4) 처리정지 요구
          <br />
          ② 제1항에 따른 권리 행사는 회사에 대해 서면, 전화, 전자우편, FAX 등을
          통하여 하실 수 있으며, 회사는 이에 대해 지체없이 조치하겠습니다.
          <br />
          ③ 정보주체가 개인정보의 오류 등에 대한 정정 또는 삭제를 요구한
          경우에는 회사는 정정 또는 삭제를 완료할 때 까지 당해 개인정보를
          이용하거나 제공하지 않습니다.
          <br />
          ...
          <br />
          ⑤ 정보주체는 개인정보보호법 등 관계법령을 위반하여 회사가 처리하고
          있는 정보주체 본인이나 타인의 개인정보 및 사생활을 침해하여서는
          아니됩니다.
          <br />
          <br />
          5. 이용자의 정보 자동수집장치의 설치 및 운영
          <br />
          회사는 정보주체의 이용정보를 저장하고, ‘쿠키(cookie)’를 사용하지
          않습니다.
          <br />
          <br />
          6. 개인정보책임자
          ...
          개인정보보호 책임자 및 담당부서를 지정, 운영하고 있습니다.
          <br />
          <br />
          ▶ 개인정보 처리방침 담당부서 정보
          <br />
          ...
          - 연락처 : 051-714-6120
          <br />
          - 이메일 : help@insystem.kr
          <br />
          <br />
          이용자는 회사의 서비스(또는 사업)를 이용하시면서 발생한 모든
          개인정보보호관련 문의, 불만처리, 피해구제 등에 관한 사항을
          개인정보보호 책임자 및 담당부서로 문의하실 수 있습니다.
          <br />
          회사는 이용자의 문의에 대해 답변 및 처리해 드릴 것입니다.
          <br />
          <br />
          기타 개인정보침해에 대한 신고나 상담이 필요하신 경우에는 아래 기관에
          문의하시기 바랍니다.
          <br />
          1. 개인정보침해신고사업단 (www.118.or.kr / 국번없이 118)
          <br />
          2. 대검찰청 사이버범죄수사단 (www.spo.go.kr / 02-3480-2000)
          <br />
          3. 경찰청 사이버테러대응사업단 (www.ctrc.go.kr / 1566-0112)
        </>
      )}
    </>
  );
