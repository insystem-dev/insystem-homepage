...
export default function SpineHealthProjectPage() {
  const handleGoBack = () => {
    window.history.back();
  };
          ...
          <div className="flex flex-col md:flex-row md:justify-start md:items-start md:gap-6">
            ...
            <div className="flex-1 flex flex-col justify-start items-start gap-8 md:gap-4">
              ...
              <div className="flex flex-col justify-start items-start gap-2 w-full">
                <p className="text-slate-50 text-base font-semibold font-['Pretendard']">
                  AI 기반 청소년 대상 척추 질환 조기 진단 및 건강관리 플랫폼
                </p>
            ...
            <div className="flex-1 w-full md:w-auto">
              <p className="text-slate-50 text-base md:text-lg font-medium font-['Pretendard'] leading-6 md:leading-7">
                청소년 척추건강관리 플랫폼은 AI 기반 근골격계 질환 조기 진단
                기술과 맞춤형 건강관리 서비스를 통합한 디지털 헬스케어
                플랫폼입니다. 스마트폰 촬영 이미지 분석을 통해 척추측만증 여부를
                판단하고, 신체 데이터 기반 개인 맞춤 운동 프로그램과 건강
                리워드(포인트) 시스템을 제공합니다. 블록체인 기반의 보상
                시스템과 부모-자녀 교류 기능을 통해 청소년의 건강습관 형성을
                지원합니다.
              </p>
            </div>
          </div>
